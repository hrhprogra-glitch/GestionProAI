...
export default function TopBar({ userName, email, onLogout }: TopBarProps) {
  return (
    <div className="relative flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 pb-6 border-b border-slate-200/80 dark:border-slate-800/80 group">
      ...
      {/* Panel de usuario con borde energético cristalizado */}
      <div className="relative flex items-center gap-4 bg-white/70 backdrop-blur-md dark:bg-slate-900/60 py-2 px-4 rounded-2xl border border-pink-500/30 dark:border-cyan-500/30 shadow-[0_0_25px_rgba(236,72,153,0.15)] dark:shadow-[0_0_25px_rgba(6,182,212,0.15)] ml-auto lg:ml-0 w-full lg:w-auto justify-between lg:justify-start overflow-hidden">
